<x-app-layout>
    <div class="max-w-[620px] mx-auto px-4 py-6" x-data="quranIndex()" x-init="loadSurahs()">
        <div class="mb-6 animate-fade-in">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">Al-Quran</h2>
            <p class="text-gray-600 dark:text-gray-400 mt-1">114 Surat</p>
        </div>

        <div class="grid grid-cols-2 gap-3 mb-6">
            <a href="{{ route('quran.index') }}" class="flex items-center p-3 bg-teal-600 dark:bg-teal-500 text-white rounded-xl shadow-sm shadow-teal-500/25">
            ...
            <a href="{{ route('quran.marked') }}" class="card-hover flex items-center p-3">
                <svg class="w-5 h-5 mr-2 text-amber-500" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"/>
                </svg>
                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Ayat Ditandai</span>
            </a>
        </div>

        <div class="relative mb-6">
            <input type="text" x-model="search" placeholder="Cari surat..." class="input pl-10">
                ...
                <a :href="`/quran/${surah.number}`" class="card-hover flex items-center p-4 group animate-slide-up">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center justify-between">
                            <div>
                                <h3 class="font-semibold text-gray-900 dark:text-white" x-text="surah.name_latin"></h3>
                                <p class="text-xs text-gray-500 dark:text-gray-400" x-text="surah.translation"></p>
                            </div>
                            <div class="text-right">
                                <p class="font-arabic text-lg text-gray-700 dark:text-gray-300" x-text="surah.name"></p>
                                <p class="text-xs text-gray-500 dark:text-gray-400" x-text="`${surah.number_of_ayahs} Ayat`"></p>
                            </div>
                        </div>
                    </div>
                </a>
